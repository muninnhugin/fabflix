...
4. In `src/MovieListServlet.java`, make sure the mysql username is `mytestuser` and password is `mypassword`.
...
- `MovieListServlet.java` is a Java servlet that talks to the database and get the stars data. It generates the HTML strings and write it to response. Open the url `localhost:8080/cs122b-fall22-project1-star-example/stars` to see the page generated by this Servlet.
